...
eval1 (R ((SuccF ()):s, (a))) = E (s, Write "Error" (Succ (a)))
eval1 (R ((PredF ()):s, (a))) = E (s, Write "Error" (Succ (a)))
eval1 (R ((NotF ()):s, (a))) = E (s, Write "Error" (Succ (a)))
eval1 (R ((AddL () e2):s, a)) = E (s, Write "Error" (Add (a) e2))
eval1 (R ((AddR (I n) ()):s, a)) = E (s, Write "Error" (Add (I n) (a)))
eval1 (R ((MulL () e2):s, a)) = E (s, Write "Error" (Mul (a) e2))
eval1 (R ((MulR (I n) ()):s, a)) = E (s, Write "Error" (Mul (I n) (a)))
eval1 (R ((AndL () e2):s, a)) = E (s, Write "Error" (And (a) e2))
eval1 (R ((AndR (B b) ()):s, a)) = E (s, Write "Error" (And (B b) (a)))
eval1 (R ((OrL () e2):s, a)) = E (s, Write "Error" (Or (a) e2))
eval1 (R ((OrR (B b) ()):s, a)) = E (s, Write "Error" (Or (B b) (a)))
eval1 (R ((LtL () e2):s, a)) = E (s, Write "Error" (Lt (a) e2))
eval1 (R ((LtR (I n) ()):s, a)) = E (s, Write "Error" (Lt (I n) (a)))
eval1 (R ((GtL () e2):s, a)) = E (s, Write "Error" (Gt (a) e2))
eval1 (R ((GtR (I n) ()):s, a)) = E (s, Write "Error" (Gt (I n) (a)))
